...
public class KkvGrid extends BaseGrid<Kkv, FreeContainer<Kkv>> {
	...
	public KkvGrid(FreeContainer<Kkv> dContainer,VaadinGridWrapper vgw, MessageSource messageSource, Domains domains, List<String> sortableContainerPropertyIds, List<String> columnNames, String messagePrefix) {
