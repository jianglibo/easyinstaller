...
public class BoxTwinGridField extends BaseTwinGridField<Set<Box>, Box, Box> {
	...
	public BoxTwinGridField(Domains domains, MessageSource messageSource, BoxRepository repository, VaadinTableWrapper vtw,
