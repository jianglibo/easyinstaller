...
public class LocaleSelectorWindow extends Window {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(LocaleSelectorWindow.class);
	...
	public LocaleSelectorWindow(MessageSource messageSource, LocaleResolver localeResolver) {
		this.messageSource = messageSource;
		this.localeResolver = localeResolver;
		setCaption(messageSource.getMessage("lanselector.title", null, UI.getCurrent().getLocale()));
