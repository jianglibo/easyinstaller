...
public class BoxGroupRepositoryImpl implements BoxGroupRepositoryCustom<BoxGroup> {
	...
	@Override
	public List<BoxGroup> getFilteredPageWithOnePhrase(Pageable page, String filterString, boolean trashed) {
		return jpqjUtil.getFilteredPage(BoxGroup.class, page, filterString, trashed, BoxGroup_.name.getName());
	}
